                ...
                <div class="card-body p-4 text-black">
                  <form action="" method="post" id="signupForm">
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <input type="tel" class="form-control form-control-lg" name="phone" id="phone" name="phone" />
                    </div>
                    <div class="form-outline mb-4">
                      <label class="form-label"><strong>Địa chỉ</strong></label>
                      <input type="text" class="form-control form-control-lg" name="address" id="address" name="address" />
                    </div>
                    <div>
