  ...
  <section>
    <div class="container text-center px-0">
      <div class="row mt-3" style="padding: 0 12px">
        <div class="col-md-3 col-sm-6 offset-sm-1 offset-md-0 mb-4 text-start">
          <h6 class="text-uppercase fw-bold mb-4">
            <i class="fas fa-gem me-3"></i>TÊN SHOP
          </h6>
          <p>Shopping BOOKLV</p>
        </div>
        <div class="col-md-4 col-sm-5 text-start mb-4">
        ...
        <div class="col-md-3 col-sm-6 offset-sm-1 offset-md-0 text-start mb-4">
          <h6 class="text-uppercase fw-bold mb-4">CSKH</h6>
          <p>
          ...
          <p>
            <a href="#!" class="text-reset">Trả Hàng & Hoàn Tiền</a>
          </p>
          <p>
        ...
        <div class="col-md-2 col-sm-5 text-start mb-md-0 mb-4">
          <!-- Links -->
          <h6 class="text-uppercase fw-bold mb-4">Liên Hệ</h6>
          <p><i class="fas fa-home me-3"></i> CTU, 3/2</p>
          <p>
            <i class="fas fa-envelope me-3"></i>
            loi@gmail.com
          </p>
          <p><i class="fas fa-phone me-3"></i> 123123</p>
        </div>
      </div>
    </div>
  </section>
