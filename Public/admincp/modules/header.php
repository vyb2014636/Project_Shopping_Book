        ...
        <div class="row" style="width: 100%; padding: 0 12px">
          ...
          <div class="navbar-nav col-md-8 d-md-flex d-none align-items-center justify-content-center p-0" id="nav-category-1">
            <div class="nav-item link-nav">
              <a class="nav-link link-nav-item text-uppercase" aria-current="page" href="index.php?page=category&query=listed"><span>Quản lý thể loại<after></after></span></a>
            </div>
            <div class="nav-item link-nav">
            ...
            <div class="nav-item link-nav">
              <a class="nav-link link-nav-item text-uppercase" href="index.php?page=books&query=listed"><span>Sản phẩm<after></after></span></a>
            </div>
          </div>
          <!--/-->
